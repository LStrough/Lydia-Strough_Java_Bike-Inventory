...
/**
 * This is the modify product controller.
 *
 *<p>This class allows the user to modify a selected product. The user can manipulate
 * the product name, inventory level, price, max, min, and associated parts. </p>
 *
...
public class ModifyProduct implements Initializable {
    ...
    /**
     * This is the product being modified.
     * */
    Product productToModify = null;
    /**
     * This is the products associated parts list.
     * */
     ...
     *
     * <p>RUNTIME ERROR: A bug in my code was found - if a product had an associated list that was NOT empty,
     * and I tried to add more associated parts, the part I added would write over the original associated part.
     * I mediated this bug by adding the last line of code in the modifyProduct method (Line 86).</p>
     *
     * This method sets the associated text fields in the modify product page with the selected products information.
     *
    ...
    public void modifyProduct(Product selectedProduct) {
        ...
        productIdTxt.setText(String.valueOf(productToModify.getId()));
        productNameTxt.setText(productToModify.getName());
        productInvTxt.setText(String.valueOf(productToModify.getStock()));
        productPriceTxt.setText(String.valueOf(productToModify.getPrice()));
        productMaxTxt.setText(String.valueOf(productToModify.getMax()));
        productMinTxt.setText(String.valueOf(productToModify.getMin()));

        partBTableView.setItems(productToModify.getAllAssociatedParts());
        associatedParts = productToModify.getAllAssociatedParts();                      //RUNTIME_ERROR
    }
     ...
     *  stays in the modify product page.</p>
     *
     ...
     * */
    public void onActionRemovePartFromProduct(ActionEvent actionEvent) throws IOException {
     ...
     *
     * <p> Product id, name, price, stock, max, and min are assigned values from the productToModify object.</p>
     *
     ...
     *
     * <p>An index variable is created and assigned with the productToModify's index. </p>
     *
     ...
     *
     * <p>The deleteProduct method is then called from the Inventory class with the productToModify object as a parameter.</p>
     *
     ...
     *
     * <p>selectedPart object is assigned whatever row the user selects in the partATableView.
     *  The selectedPart is then added to associatedParts.</p>
     *
     * <p>partBTableView then populates all associatedParts.</p>
     *
     ...
     *
     * <p>This is the first method to run when the ModifyProduct page is pulled up.</p>
     *
     ...
     *
     * <p>partBTableView then assigns its rows to the associated parts that are associated with the product to modify.</p>
     *
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        System.out.println("Modify Product: I am initialized!");
